...
{
    public class CRMClientActivitySucceedingRule : SourceCode.Workflow.Design.Outcome.Base.OutcomeSucceedingRule
    {
        public CRMClientActivitySucceedingRule() : base()
        {
        ...
        {
            DesignCRMClient.CRMClientActivitySucceedingRule item = base.Clone<DesignCRMClient.CRMClientActivitySucceedingRule>();
