...
{
    public class CRMClientProcessFinishRule : ProcessFinishRule
    {
        // Methods
        public CRMClientProcessFinishRule()
        {
        ...
        {
            DesignCRMClient.CRMClientProcessFinishRule item = base.Clone<DesignCRMClient.CRMClientProcessFinishRule>();
        ...
        protected override void PrepareCodeFiles()
        {
            ...
            {
                CodeFileResolver resolver = new CodeFileResolver(base.Extender, @"CRMClient.ProcessFinishRule\EventItem");
