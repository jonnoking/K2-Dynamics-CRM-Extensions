...
function checkArray(stringarray, delimiter, searchvalue) {

    var arrayValues = stringarray.split(delimiter);
    for (var i = 0; i < arrayValues.length; i++) {
        if ($.trim(arrayValues[i].toLowerCase()) == searchvalue.toLowerCase()) {
            return true;
        }
    }
    return false;
