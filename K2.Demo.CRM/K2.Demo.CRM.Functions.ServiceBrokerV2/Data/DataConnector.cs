...
using K2.Demo.CRM.Functions.ServiceBrokerV2.Interfaces;
using System.Xml;
...
namespace K2.Demo.CRM.Functions.ServiceBrokerV2.Data
{
    class DataConnector : IDataConnector
    {
        ...
        private string crmurl = string.Empty;
        private string crmorganization = string.Empty;
        private string connectionString = string.Empty;
        private CRMConfig crmconfig = null;
        ...
        {
            crmurl = serviceBroker.Service.ServiceConfiguration["CRMUrl"].ToString();
            crmorganization = serviceBroker.Service.ServiceConfiguration["CRMOrganization"].ToString();
        }
        #endregion
        ...
        {
            serviceBroker.Service.ServiceConfiguration.Add("CRMUrl", true, "");
            serviceBroker.Service.ServiceConfiguration.Add("CRMOrganization", true, "");
        ...
        {
            serviceBroker.Service.Name = "K2CRMFunctionsServiceBroker" + crmurl;
            serviceBroker.Service.MetaData.DisplayName = "K2 Dynamics CRM Functions - " + crmurl;
            serviceBroker.Service.MetaData.Description = "K2 Dynamics CRM Functions - " + crmurl + " - " + crmorganization;
        }
        #endregion
